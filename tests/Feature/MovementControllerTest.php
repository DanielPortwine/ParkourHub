...
//    }
    ...
    /** @test */
    public function link_equipment_non_logged_in_user_redirects_to_login()
    {
        $response = $this->post(route('movement_equipment_link'));

        $response->assertRedirect('/email/verify');
    }

    /** @test */
    public function link_equipment_non_premium_user_redirects_to_premium()
    {
        $user = User::factory()->create();

        $response = $this->actingAs($user)->post(route('movement_equipment_link'));

        $response->assertRedirect('/premium');
    }

    /** @test */
    public function link_equipment_premium_user_can_not_link_equipment_already_linked()
    {
        $type = MovementType::factory()->create(['name' => 'Move']);
        $category = MovementCategory::factory()->create();
        $movement = Movement::factory()->create();
        ...
        $response = $this->actingAs($this->premiumUser)->post(route('movement_equipment_link'), [
            'movement' => $movement->id,
            'equipment' => $equipment->id,
        ]);

        $this->assertDatabaseCount('movements_equipments', 1)
            ->assertDatabaseHas('movements_equipments', [
                'movement_id' => $movement->id,
    ...
    /** @test */
    public function link_equipment_premium_user_can_link_equipment()
    {
        $type = MovementType::factory()->create(['name' => 'Move']);
        $category = MovementCategory::factory()->create();
        $movement = Movement::factory()->create();
    ...
    /** @test */
    public function unlink_equipment_non_logged_in_user_redirects_to_login()
    {
        $response = $this->post(route('movement_equipment_unlink'));

        $response->assertRedirect('/email/verify');
    }

    /** @test */
    public function unlink_equipment_non_premium_user_redirects_to_premium()
    {
        $user = User::factory()->create();

        $response = $this->actingAs($user)->post(route('movement_equipment_unlink'));

        $response->assertRedirect('/premium');
    }

    /** @test */
    public function unlink_equipment_random_premium_user_can_not_unlink_equipment()
    {
        $user = User::factory()->create();
        $type = MovementType::factory()->create(['name' => 'Move']);
        $category = MovementCategory::factory()->create();
        ...
        $movement->equipment()->attach($equipment->id, ['user_id' => $user->id]);

        $response = $this->actingAs($this->premiumUser)->post(route('movement_equipment_unlink'), [
            'movement' => $movement->id,
            'equipment' => $equipment->id,
        ]);
    ...
    /** @test */
    public function unlink_equipment_link_owner_premium_user_can_unlink_equipment()
    {
        $user = User::factory()->create();
        $type = MovementType::factory()->create(['name' => 'Move']);
        $category = MovementCategory::factory()->create();
    ...
    /** @test */
    public function unlink_equipment_movement_owner_premium_user_can_unlink_equipment()
    {
        $user = User::factory()->create();
        $type = MovementType::factory()->create(['name' => 'Move']);
        $category = MovementCategory::factory()->create();
    ...
    /** @test */
    public function unlink_equipment_equipment_owner_premium_user_can_unlink_equipment()
    {
        $user = User::factory()->create();
        $type = MovementType::factory()->create(['name' => 'Move']);
        $category = MovementCategory::factory()->create();
